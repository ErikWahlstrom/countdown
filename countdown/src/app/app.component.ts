...
export class AppComponent {
  ...
  constructor() {
    ...
    const subscribe = this.source.subscribe(val => {
      ...
      this.timeLeft = (this.endDate.getTime() / msToDays) - (now.getTime() / msToDays);
      this.timeLeftDate = new Date((this.endDate.getTime()) - (now.getTime()));
      ...
      const wholeDaysLeft = Math.trunc(this.timeLeft);
